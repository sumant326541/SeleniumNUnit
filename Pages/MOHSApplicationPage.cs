...
namespace SeleniumNUnit.Pages
{
    public class MOHSApplicationPage
    {
        ...
        private IWebElement ParentNextButton => driver.FindElement(By.XPath("(//button[contains(@aria-label, 'Next')])[1]"));
        ...
        private IWebElement StudentDOBField => driver.FindElement(By.Id("SingleLine3-arialabel"));
        ...
        private IWebElement StudentNextButton => driver.FindElement(By.XPath("(//button[contains(@aria-label, 'Next')])[2]"));
        ...
        public void FillParentInformation()
        {
            ...
            this.PreferredStartDateCalanderField.SendKeys("30-Jul-2024");
        ...
        public void FillStudentInformation()
        {
            ...
            this.StudentDOBField.SendKeys("12/04/1999");
            ...
            this.StudentCurrentSchoolingDropDown.Click();
            Thread.Sleep(1000);
